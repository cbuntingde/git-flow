...
# /git-flow:back-to-main

Run step 6 of the git-flow procedure without step 5: discard the
branch and return to default. Does not merge.

## Usage

```text
/git-flow:back-to-main [--delete-remote]
```
...
- `/git-flow:merge` — if the branch is worth keeping.
